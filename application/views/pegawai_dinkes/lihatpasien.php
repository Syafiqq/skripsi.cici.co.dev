                                ...
                                <div class="x_title">
                                    ...
                                    <div class="btn-group pull-right">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="<?php echo base_url(); ?>pegawai/dinkes/export/xls/kader">XLS</a></li>
                                            <li><a href="<?php echo base_url(); ?>pegawai/dinkes/export/pdf/kader">PDF</a></li>
                                        </ul>
                                    </div>
                                    ...
                                    <table id="example" class="table table-striped responsive-utilities jambo_table table-bordered">
                                        <thead>
                                            <tr class="heading">
                                                ...
                                                <th style="vertical-align: middle; text-align: center">`Action</span></th>
                                            </tr>
                                        </thead>
                                            ...
                                            <?php foreach ($listpasien->result() as $baris) : ?>
                                                <tr class="even pointer">
                                                    ...
                                                    <td style="vertical-align: middle; text-align: center">
                                                        <a href="<?php echo base_url() . 'pegawai/dinkes/view/riwayat/' . $baris->id; ?>" data-toggle="modal" data-placement="bottom" title="Lihat Detail" class="btn btn-xs btn-info"><i class="fa fa-eye"></i> Lihat Riwayat Pasien</a>
                                                    </td>
                                                </tr>
                                                                ...
                                                                <div class="col-md-6 col-sm-6 col-xs-6">	
                                                                    <center>
                                                                        <div class="avatar-view" >
                                                                            <img src="<?php echo base_url(); ?><?php echo '/aset/foto/' . $baris->foto; ?>" alt="Sales"/>
                                                                        </div>
                                                                        <h3><?php echo $baris->nama; ?></h3></center>
                                                                </div>
                                                                <div class="col-md-6 col-sm-6 col-xs-6">
                                                                    <ul class="list-unstyled user_data">
                                                                        <li><i class="fa fa-credit-card user-profile-icon"></i> <?php echo $baris->NIP; ?> </li>
                                                                        <li><i class="fa fa-smile-o user-profile-icon"></i> <?php echo $baris->tempat_lahir; ?>/<?php echo $baris->tanggal_lahir; ?></li>
                                                                        <li><i class="fa fa-map-marker user-profile-icon"></i> <?php echo $baris->alamat; ?></li>
