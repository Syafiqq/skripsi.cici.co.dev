                                ...
                                <div class="x_title">
                                    ...
                                    <div class="btn-group pull-right">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="<?php echo base_url(); ?>puskesmas/pegawai/puskesmas/export/xls/posbindu">XLS</a></li>
                                            <li><a href="<?php echo base_url(); ?>puskesmas/pegawai/puskesmas/export/pdf/posbindu">PDF</a></li>
                                        </ul>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                        ...
                                        <tbody>
                                            <?php foreach ($listposbindu->result() as $baris) : ?>
                                                <tr class="even pointer">
                                                    ...
                                                    <td>
                                                        <a href="#modal-lihat-pegawai<?php echo $baris->id; ?>" data-toggle="modal" data-placement="bottom" title="Lihat Detail" class="btn btn-xs btn-info"><i class="fa fa-eye"></i> Lihat Kader Posbindu</a>
                                                    </td>
                                                </tr>
