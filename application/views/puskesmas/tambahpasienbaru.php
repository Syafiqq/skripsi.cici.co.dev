                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <form class="form-horizontal" action="<?php echo site_url('puskesmas/add/createpasien/') ?>" method="post" enctype="multipart/form-data">
                                            <input type="hidden" name="id_puskesmas" value="<?php echo $this->m_index->getIdPuskesmasByPegawaiPuskesmas($this->session->userdata('id_users')); ?>">
                                            <div class="item form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="ktp">Nomor KTP<span class="required"></span></label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="ktp" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" name="ktp" placeholder="Isikan nomor KTP" required="required" type="number">
                                                </div>
                                            </div>
                                            <div class="item form-group">
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="hp" type="tel" name="hp" placeholder="Masukkan Nomor Telepon Pasien" data-validate-length-range="5,20" class="optional form-control col-md-7 col-xs-12">
                                                </div>
                                            </div>
