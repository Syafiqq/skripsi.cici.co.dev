    ...
    <body class="nav-md">
        <div class="container body">
            <div class="main_container">
                ...
                <div class="right_col">                    
                    <center><h1>Stroke Monitoring System</h1></center>
                    <!-- top tiles -->
                    <div class="row tile_count">
                        <div class="col-md-offset-1 animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                            <div class="left"></div>
                            <div class="right">
                                <span class="count_top"><i class="fa fa-user"></i> Total Pegawai Dinkes</span>
                                <div class="count"><?php echo $this->db->count_all('pegawai_dinkes'); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                            <div class="left"></div>
                            <div class="right">
                                <span class="count_top"><i class="fa fa-user"></i> Total Puskesmas</span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">                                
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2>Puskesmas location <small>geo-presentation</small></h2>
                                            <div class="clearfix"></div>
                                        </div>
                                        <div class="x_content">
