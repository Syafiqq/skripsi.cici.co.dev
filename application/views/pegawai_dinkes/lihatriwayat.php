                                    ...
                                    <?php if ($listriwayat->num_rows() != 0) { ?>
                                        <div class="btn-group pull-right">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="<?php echo base_url(); ?>pegawai/dinkes/export/xls/riwayat/<?php echo $this->uri->segment(3); ?>">XLS</a></li>
                                                <li><a href="<?php echo base_url(); ?>pegawai/dinkes/export/pdf/riwayat/<?php echo $this->uri->segment(3); ?>">PDF</a></li>
                                            </ul>
                                        </div>                                    
                                    <?php } ?>
