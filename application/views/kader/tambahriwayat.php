                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li><a  href="<?php echo base_url(); ?>kader/petunjuk"><i class="fa fa-bullhorn"></i>Petunjuk</span></a></li>
                                </ul>
                            </div>
                        </div>
                        <!-- /sidebar menu -->
                    ...
                    <div class="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Formulir Tambah Riwayat Sakit Pasien</h2>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="x_content">
                                        <div >
                                            <form class="form-horizontal" action="<?php echo base_url(); ?>kader/add/riwayat" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 ">
                                                        <input type="number" id="merokok" name="merokok" required="required" data-validate-minmax="0,1000" class="form-control col-md-7 col-xs-12" placeholder="Isi jumlah batang per hari">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">                                                                                            
                                                        <select class="form-control select" name="olahraga" required>
                                                            ...
                                                            <option value="1">Ya</option>
                                                            <option value="0">Tidak</option>
                                                            <option value="0.5">Jarang</option>
                                                        </select>
                                                    </div>
                                                </div> 
                                                <div class="item form-group">
