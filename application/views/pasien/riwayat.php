                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li>
                                        <a href="<?php echo base_url('index.php/pasien/artikel'); ?>">Artikel</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url('index.php/pasien/data-user'); ?>">Data User</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url('index.php/pasien/data-latih'); ?>">Data Latih</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url('index.php/pasien/deteksi'); ?>">Deteksi</a>
                                    </li>
                                    <li  class="active">
                                        <a href="<?php echo base_url('index.php/pasien/riwayat'); ?>">Riwayat Deteksi</a>
                                    </li>
                                    <li>
...
<section class="complete-content content-footer-space">
    ...
    <div class="about-intro-wrap pull-left">
        <div class="bread-crumb-wrap ibc-wrap-6">
            <div class="container">
                ...
                <div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
                    <div class="bread-heading"><h1>Riwayat Deteksi</h1></div>
        ...
        <div class="container">
            <div class="row">
                <br>
                <h1 style="text-align: center">Ini Adalah Halaman Riwayat Deteksi</h1>
                <br>
            </div>
        </div>
    </div>
