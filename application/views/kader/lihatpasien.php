                                ...
                                <div class="x_title">
                                    ...
                                    <div class="btn-group pull-right">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="<?php echo base_url(); ?>kader/export/xls/pasien">XLS</a></li>
                                            <li><a href="<?php echo base_url(); ?>kader/export/pdf/pasien">PDF</a></li>
                                        </ul>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                            ...
                                            <?php foreach ($listpasien->result() as $baris) : ?>
                                                <tr class="even pointer">
                                                    ...
                                                    <td> <?php
                                                        ...
                                                        ?></td>
                                                    <td> 
                                                        <?php // echo $baris->tempat_lahir . ", " . $baris->tgl_lahir; ?>
                                                        <?php
                                                    ...
                                                    <td style="vertical-align: middle; text-align: center; width: 15%;">
                                                        <a style="width: 100%;" href="<?php echo base_url() . 'kader/view/riwayat/' . $baris->id; ?>" data-toggle="modal" data-placement="bottom" title="Lihat Detail" class="btn btn-xs btn-info"><i class="fa fa-eye"></i> Lihat Riwayat Pasien</a>
                                                        <a style="width: 100%;" href="<?php echo base_url() . 'kader/edit/pasien/' . $baris->id ?>" data-toggle="modal" data-placement="bottom" title="Edit Pasien" class="btn btn-xs btn-info"><i class="fa fa-pencil"></i> Edit Data Pasien</a>
                                                        <a style="width: 100%;" href="<?php echo base_url() . 'kader/add/riwayat/' . $baris->id; ?>" data-toggle="modal" data-placement="bottom" title="Tambah Riwayat" class="btn btn-xs btn-info"><i class="fa fa-plus"></i> Tambah Riwayat Pasien</a>
                                                        <a style="width: 100%;" href="#modal-delete-pegawai<?php echo $baris->id; ?>" data-toggle="modal" data-placement="bottom" title="Hapus Pasien" class="btn btn-xs btn-info"><i class="fa fa-times"></i> Hapus Data Pasien</a>
                                                    </td>
                                                </tr>
                                            ...
                                            <div id="modal-delete-pegawai<?php echo $baris->id; ?>"  class="modal animated pulse"  tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">  
                                                        <form action="<?php echo site_url('kader/deletepasien/' . $baris->id); ?>" method="post">                            
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="<?php echo site_url('kader/deletepegawai/' . $baris->id); ?>" class="btn btn-success btn-lg">Ya</a>
