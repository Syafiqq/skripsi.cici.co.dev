...
<section class="complete-content content-footer-space" style="margin-bottom: 0 !important;">
    <!--Mid Content Start-->
    <div class="about-intro-wrap pull-left">
        ...
        <div class="container">
            <div class="row">
                <form action="<?php echo base_url('index.php/'); ?>main_controller/sendEmail" method="post" style="padding: 50px 20% 0 20%">
                    <table width="100%">
                        <tr>
                        ...
                        <tr>
                            <td width="25%" style="padding: 15px 0 15px 0; font-size: medium">Email</td>
                            <td width="5%" style="text-align: center">:</td>
                            <td colspan="2" width="70%">
                        ...
                        <tr>
                            <td width="25%" style="padding: 15px 0 15px 0; font-size: medium">Masukan</td>
                            <td width="5%" style="text-align: center">:</td>
                            <td colspan="2" width="70%">
                                <input style="width: 100%" type="text" name="problem">
                            </td>
                        </tr>
                        <tr>
                            <td width="25%" style="padding: 15px 0 15px 0">&nbsp;</td>
                            <td width="5%"></td>
                            <td width="55%"><?php echo $this->session->flashdata('send_message')?></td>
