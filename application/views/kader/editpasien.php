                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="">
                                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                        <img src="<?php echo base_url(); ?>assets/backend/images/img.jpg" alt=""><?php echo $this->m_kader->getNamaKader($this->session->userdata('id_users')); ?><span class=" fa fa-angle-down"></span>
                                    </a>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form class="form-horizontal form-label-left" action="<?php echo site_url('kader/edit/updatepasien') ?>" method="POST">
                                        <?php foreach ($listpasien->result() as $baris) : ?>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="ktp" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" name="ktp" placeholder="Isikan nomor KTP" required="required" type="text" value="<?php echo $baris->ktp ?>">
                                                </div>
                                            </div>
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" name="nama" placeholder="Isikan nama lengkap" required="required" type="text" value="<?php echo $baris->nama ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-3">
                                                    <input id="tempatlahir" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="tempatlahir" placeholder="Tempat Lahir" required="required" type="text" value="<?php echo $baris->tempat_lahir ?>">
                                                </div>
                                                <div class="col-md-3 col-sm-3 col-xs-3">
                                                    <input type="date" class="form-control" data-inputmask="'mask': '99/99/9999'" placeholder="Tanggal Lahir" id="tanggallahir" name="tanggallahir" value="<?php echo $baris->tgl_lahir ?>">
                                                </div>
                                            </div>
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <textarea id="alamat" required="required" name="alamat" class="form-control col-md-7 col-xs-12" placeholder="Isikan Alamat Lengkap" value="<?php echo $baris->alamat ?>"></textarea>
                                                </div>
                                            </div>
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-3">
                                                    <input type="number" id="rt" name="rt" required="required" data-validate-minmax="1,100" class="form-control col-md-7 col-xs-12" placeholder="RT" value="<?php echo $baris->rt ?>">
                                                </div>
                                                <div class="col-md-3 col-sm-3 col-xs-3">
                                                    <input type="number" id="rw" name="rw" required="required" data-validate-minmax="1,100" class="form-control col-md-7 col-xs-12" placeholder="RW" value="<?php echo $baris->rw ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="item form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="occupation">No HP <span class="required"></span></label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="hp" type="text" name="hp" placeholder="Masukkan Nomor Telepon Pasien" data-validate-length-range="5,20" class="optional form-control col-md-7 col-xs-12" value="<?php echo $baris->hp ?>">
                                                </div>
                                            </div>
