...
<section class="complete-content content-footer-space">
    ...
    <div class="about-intro-wrap pull-left">
        <div class="bread-crumb-wrap ibc-wrap-6">
            <div class="container">
                ...
                <div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
                    <div class="bread-heading"><h1>Hasil Deteksi</h1></div>
        ...
        <div class="container">
            <div class="row">
                <br>
                <h1 style="text-align: center">Hasil deteksi adalah = <?php echo $class?></h1>
                <br>
                <h3 style="text-align: center"><?php echo $saran?></h3>
            </div>
        </div>
    </div>
</section>
