                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    <li><a href="<?php echo base_url(); ?>puskesmas"><i class="fa fa-home"></i>Beranda</span></a></li>
                                    <li><a href="<?php echo base_url(); ?>puskesmas/view/puskesmas"><i class="fa fa-user"></i>Profil</a></li>
                                    <li><a><i class="fa fa-edit"></i>Riwayat Deteksi<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu" style="display: none">
                                            <li><a href="<?php echo base_url(); ?>puskesmas/add/pegawai">Saran</a></li>
                                        </ul>
                                    </li>
                                    <li><a  href="<?php echo base_url(); ?>puskesmas/view/petunjuk"><i class="fa fa-bullhorn"></i>Artikel</span></a></li>
                                    <li><a  href="<?php echo base_url(); ?>puskesmas/view/petunjuk"><i class="fa fa-bullhorn"></i>Data Latih</span></a></li>
                                </ul>
                            </div>
                        </div>
                        <!-- /sidebar menu -->
                                    ...
                                    <?php if ($listriwayat->num_rows() != 0) { ?>
                                        <div class="btn-group pull-right">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="<?php echo base_url(); ?>puskesmas/puskesmas/export/xls/riwayat/<?php echo $this->uri->segment(3); ?>">XLS</a></li>
                                                <li><a href="<?php echo base_url(); ?>puskesmas/puskesmas/export/pdf/riwayat/<?php echo $this->uri->segment(3); ?>">PDF</a></li>
                                            </ul>
                                        </div>                                    
                                    <?php } ?>
                                    <div class="clearfix"></div>
