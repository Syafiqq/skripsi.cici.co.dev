                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="">
                                    ...
                                    <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                                        <li><a href="<?php echo base_url(); ?>pegawai/dinkes/view/profil"><i class="fa fa-user pull-right"></i> Profil</a>
                                        </li>
                                ...
                                <div class="x_title">
                                    ...
                                    <div class="btn-group pull-right">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="<?php echo base_url(); ?>pegawai/dinkes/export/xls/posbindu">XLS</a></li>
                                            <li><a href="<?php echo base_url(); ?>pegawai/dinkes/export/pdf/posbindu">PDF</a></li>
                                        </ul>
                                    </div>
                                                    ...
                                                    <div class="modal-content">  
                                                        <div class="modal-header">
                                                            ...
                                                            <h2 class="modal-title" >
                                                                <font color="#000000">Detail Posbindu</font> 
                                                            </h2>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row"> 
                                                                ...
                                                                <?php
                                                                $no = 1;
                                                                $kader = $this->m_dinkes->getListKaderByIdPosbindu($baris->id);
                                                                foreach ($kader->result() as $kader) :
                                                                    echo '<div class="col-md-6 col-sm-6 col-xs-6">';
                                                                    echo '<p>';
                                                                    echo $no . '. ' . $kader->nama_kader;
                                                                    echo '</p>';
                                                                    echo '</div>';
                                                                    $no++;
                                                                endforeach;
