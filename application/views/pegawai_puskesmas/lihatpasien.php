                                ...
                                <div class="x_title">
                                    ...
                                    <div class="btn-group pull-right">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="<?php echo base_url(); ?>puskesmas/pegawai/puskesmas/export/xls/kader">XLS</a></li>
                                            <li><a href="<?php echo base_url(); ?>puskesmas/pegawai/puskesmas/export/pdf/kader">PDF</a></li>
                                        </ul>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
