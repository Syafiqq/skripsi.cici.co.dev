                                ...
                                <div class="x_panel">
                                    <?php foreach ($profil->result() as $baris) : ?>
                                                ...
                                                <div class="profile_img">
                                                    ...
                                                    <div id="crop-avatar">
                                                        ...
                                                        <div class="container" style="text-align: center;">
                                                            <form action="<?php echo base_url() ?>puskesmas/edit/profilepicture" method="post" enctype="multipart/form-data">
                                        ...
                                        <div id="modal-edit-pegawai"  class="modal animated pulse"  tabindex="-1" role="dialog" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">  
                                                    <form action="<?php echo site_url('puskesmas/edit/pegawai/'); ?>" method="post">                            
                                        ...
                                        <div id="modal-edit-account"  class="modal animated pulse"  tabindex="-1" role="dialog" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">  
                                                    <form action="<?php echo site_url('puskesmas/edit/user/'); ?>" method="post">                            
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                            <h2 class="modal-title" >
