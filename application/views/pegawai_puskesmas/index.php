                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row tile_count">
                        <div class="animated flipInY col-md-3 col-sm-3 col-xs-3 tile_stats_count">
                            <div class="left"></div>
                            <div class="right">
                                <span class="count_top"><i class="fa fa-user"></i> Total Pegawai Puskesmas</span>
                                <div class="count">
                                    <?php
                                    echo $this->m_index->countPegawaiPuskesmas($this->m_index->getIdPuskesmasByPegawaiPuskesmas($this->session->userdata('id_users')));
                                    ?>		
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="animated flipInY col-md-3 col-sm-3 col-xs-3 tile_stats_count">
                            ...
                            <div class="right">
                                ...
                                <div class="count">
                                    <?php
                                    echo $this->m_index->countPosbinduByIdPuskesmas($this->m_index->getIdPuskesmasByPegawaiPuskesmas($this->session->userdata('id_users')));
                                    ?>
                                </div>                                
                            </div>
                        </div>
                        <div class="animated flipInY col-md-3 col-sm-3 col-xs-3 tile_stats_count">
                            ...
                            <div class="right">
                                ...
                                <div class="count">
                                    <?php
                                    echo $this->m_index->countKaderByIdPuskesmas($this->m_index->getIdPuskesmasByPegawaiPuskesmas($this->session->userdata('id_users')));
                                    ?>
                                </div>
                            </div>
                        </div>
                        <div class="animated flipInY col-md-3 col-sm-3 col-xs-3 tile_stats_count">
                            ...
                            <div class="right">
                                ...
                                <div class="count">
                                    <?php
                                    echo $this->m_index->countPasienByIdPuskesmas($this->m_index->getIdPuskesmasByPegawaiPuskesmas($this->session->userdata('id_users')));
                                    ?>
                                </div>
                            </div>
                        </div>
