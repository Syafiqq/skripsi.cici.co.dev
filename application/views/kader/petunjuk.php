...
<html lang="en">
    ...
    <body class="nav-md">
        ...
        <!-- chart js -->
        <script src="<?php echo base_url(); ?>aset/js/chartjs/chart.min.js"></script>
        <!-- bootstrap progress js -->
        <script src="<?php echo base_url(); ?>aset/js/progressbar/bootstrap-progressbar.min.js"></script>
        <script src="<?php echo base_url(); ?>aset/js/nicescroll/jquery.nicescroll.min.js"></script>
        <!-- icheck -->
        <script src="<?php echo base_url(); ?>aset/js/icheck/icheck.min.js"></script>

        <script src="<?php echo base_url(); ?>aset/js/custom.js"></script>

        <!-- image cropping -->
        <script src="<?php echo base_url(); ?>aset/js/cropping/cropper.min.js"></script>
        <script src="<?php echo base_url(); ?>aset/js/cropping/main.js"></script>


        <!-- daterangepicker -->
        <script type="text/javascript" src="<?php echo base_url(); ?>aset/js/moment.min.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>aset/js/datepicker/daterangepicker.js"></script>
        <!-- moris js -->
        <script src="<?php echo base_url(); ?>aset/js/moris/raphael-min.js"></script>
        <script src="<?php echo base_url(); ?>aset/js/moris/morris.js"></script>
        <script>
            $(function () {
                var day_data = [
                    {
