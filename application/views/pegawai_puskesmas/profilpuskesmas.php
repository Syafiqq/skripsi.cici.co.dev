                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <?php foreach ($listpuskesmas->result() as $baris) : ?>
                                        <div class="x_title">
                                            <h2>Puskesmas <?php echo $baris->nama_puskesmas; ?></h2>
                                            <div class="clearfix"></div>
                                        </div>
                                        <div class="x_content">
                                                ...
                                                <div class="profile_img">
                                                    ...
                                                    <div id="crop-avatar">
                                                        ...
                                                        <div class="avatar-view">
                                                            <img src="<?php echo base_url(); ?>assets/foto/logo_dinkes.png" alt="Avatar">
                                                        </div>
                                                        <!-- Loading state -->
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <div class="profile_title">
                                                    <div class="col-md-9">
                                                        <h2><?php echo $baris->alamat . ' Kecamatan ' . $this->m_index->getNamaKecamatan($baris->id_kecamatan) . ' Kelurahan ' . $this->m_index->getNamaKelurahan($baris->id_kelurahan) . ' RT ' . $baris->rt . ' RW ' . $baris->rw; ?></h2>
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="profile_title">
