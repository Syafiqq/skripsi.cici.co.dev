                            ...
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <div class="btn-group pull-right">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="<?php echo base_url(); ?>puskesmas/puskesmas/export/xls/posbindu">XLS</a></li>
                                            <li><a href="<?php echo base_url(); ?>puskesmas/puskesmas/export/pdf/posbindu">PDF</a></li>
                                        </ul>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <table id="example" class="table table-striped responsive-utilities jambo_table table-bordered">
                                        ...
                                        <tbody>
                                            <?php foreach ($listposbindu->result() as $baris) : ?>
                                                <tr class="even pointer">
                                                    ...
                                                    <td style="width: 15%">
                                                        <a href="#modal-lihat-pegawai<?php echo $baris->id; ?>" data-toggle="modal" data-placement="bottom" title="Lihat Kader Posbindu" class="btn btn-xs btn-info"><i class="fa fa-eye"></i> Lihat Kader Posbindu</a>
                                                        <a href="<?php echo base_url() . 'puskesmas/edit/posbindu/' . $baris->id; ?>" data-toggle="modal" data-placement="bottom" title="Edit Data Posbindu" class="btn btn-xs btn-info"><i class="fa fa-eye"></i> Edit Data Posbindu</a>
                                                        <a href="#modal-delete-pegawai<?php echo $baris->id; ?>" data-toggle="modal" data-placement="bottom" title="Hapus Data Posbindu" class="btn btn-xs btn-info"><i class="fa fa-eye"></i> Hapus Data Posbindu</a>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <div class="modal-content">  
                                                        <div class="modal-header">
                                                            ...
                                                            <h2 class="modal-title" >
                                                                <font color="#000000">Daftar Kader Posbindu</font> 
                                                            </h2>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row"> 
                                                                <div class="col-sm-12 col-md-12 col-xs-12">
                                                                    <?php
                                                                    $kader = $this->m_puskesmas->getListKaderByIdPosbindu($baris->id);
                                                                    if ($kader->result() != NULL) {
                                                                        ?>
                                                                        <ul>
                                                                            <?php foreach ($kader->result() as $kader) : ?>
                                                                                <li><?php echo $kader->nama_kader; ?></li>
                                                                            <?php endforeach; ?>
                                                                            <ul>
                                                                                <?php
                                                                            } else {
                                                                                echo '<p style="text-align:center;">Kader Tidak Ditemukan</p>';
                                                                            }
                                                                            ?>
                                                                        </ul>
                                                                </div>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">  
                                                        ...
                                                        <div class="modal-footer">
                                                            <button class="btn btn-default btn-lg"><a href="<?php echo base_url() . 'puskesmas/delete/posbindu/' . $baris->id; ?>" class="btn btn-success btn-lg">Ya</a></button>
